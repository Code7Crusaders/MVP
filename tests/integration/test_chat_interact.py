...
def test_chat_valid_input(client, mocker):
    ...
    mocker.patch("app.chat_controller.get_answer", return_value=mock_response)
...
def test_chat_internal_server_error(client, mocker):
    """Test /api/chat_interact handling an internal server error."""
    mocker.patch("app.chat_controller.get_answer", side_effect=Exception("Unexpected error"))
